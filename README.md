...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=html,css,tailwindcss,bootstrap,materialui,js,ts,react,redux,nextjs,vite,cs,cpp,c,py,r,go,java,git,github,postman,visualstudio,vscode,androidstudio,anaconda,mongodb,nodejs,expressjs,postgres,sqlite,mysql,npm,pycharm,linux,ubuntu,windows,notion,netlify,vercel,trello,clicup",gmail,/>
  </a>
</p>
